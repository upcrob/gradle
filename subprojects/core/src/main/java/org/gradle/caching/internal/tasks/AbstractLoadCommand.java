...
public abstract class AbstractLoadCommand<I, O> {
    ...
    public AbstractLoadCommand(BuildCacheKey key, SortedSet<? extends OutputPropertySpec> outputProperties, TaskInternal task, FileCollection localStateFiles, TaskOutputsGenerationListener taskOutputsGenerationListener, TaskArtifactState taskArtifactState, FileSystemMirror fileSystemMirror, StringInterner stringInterner, TaskOutputOriginFactory taskOutputOriginFactory) {
        this.key = key;
